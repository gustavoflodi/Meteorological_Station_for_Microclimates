O hardware necessário para a aplicação da estação de microclimas consistiu no microcontrolador target Beagle Bone Black e no sensor de pressão e temperatura BMP280.
